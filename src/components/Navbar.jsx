            ...
            <Flex alignItems="center" justifyContent="space-between" wrap="wrap">
                ...
                <IconButton
                    ...
                    icon={
                        showCloseIcon ? (
                            <motion.div
                                whileHover={{ scale: 1.2, color: '#734F96' }}
                                animate={{ y: [0, -5, 0] }}
                ...
                <Flex
                    ...
                    whiteSpace="nowrap"
                >
                    {['PLAYER BIO', 'VOLLEYBALL FILM', 'ASK ALLY', 'PLAYER CARDS', 'EXTENDED RALLY', 'ACADEMICS', 'CONTACT'].map((text, index) => (
                        <ChakraLink
                            key={index}
                            as={ScrollLink}
                            ...
                            color="#734F96"
                            position="relative"
                            _hover={{ transform: 'scale(1.05)', transition: 'transform 0.2s', color: '#FFD700' }}
                            _after={{
                                content: '""',
                                position: 'absolute',
                                bottom: '-0.2rem',
